                    ...
                    return (        
                        <div className='search-container'>
                            <div className='search-control'>
                                ...
                                <Link to ='/search/books'><button data-id='6' className='search-button' onClick={handleStyle}>Books</button></Link>
                                <Link to ='/search/videos'><button data-id='7'className='search-button hide' onClick={handleStyle}>Videos</button></Link> 
                            </div>

                            <div className='hide screen search-screen form'>
                                <form action="/search">
                                    <input type="text" id="searchs" name="fname" className='texts' placeholder="Enter Your Keyword" />
