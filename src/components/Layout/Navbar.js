            ...
            <ProductConsumer>
                {value=>{
                    ...
                    return <div id='nav'>
                        ...
                        <nav>
                            <Link to ='/'>
                                <button data-id="0" className='hover med' onClick={handleStyle}>
                            ...
                            <Link to ='/search'>
                                <button data-id="1" className='med' onClick={handleStyle}>
                            ...
                            <Link to ='/board'>
                                <button data-id="2" className='med' onClick={handleStyle}>
                            ...
                            <Link to ='/comment'>
                                <button data-id="3" className='med' onClick={handleStyle}>
                            ...
                            <Link to ='/about'>
                                <button data-id="4" className='med' onClick={handleStyle}>
